...
\traitor{11}{Let them in}{Lasst sie herein}
...
\Trightnow{
    ...
    \begin{itemize}
        ...
        \bitem Lege ein pinkes Gespenste Token mit dem gesicht nach unten in die Eingangshalle(Entrance Hall) sowie in alle Räume mit einem Fenster nach draussen. Diese Gespenster sind noch außerhalb des Hauses und erwarten, daß Du oder der Verrückte sie hereinlassen. Wenn ein Fenster zu einer Wand zeigt wird dort KEIN Token platziert.
    \end{itemize}
}
